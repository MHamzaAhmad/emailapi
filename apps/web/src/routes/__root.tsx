...
export const Route = createRootRoute({
  head: () => ({
    ...
    scripts: [
      // PostHog analytics - async loaded with performance optimizations
      {
...
posthog.init('phc_2626jWn9VFnpMMlY9JeccLaH9kV1BEMvtpKTq5Cbmz7',{api_host:'https://us.i.posthog.com',defaults:'2025-11-30',person_profiles:'identified_only',__preview_deferred_init_extensions:true});`,
      },
      // MsgMorph widget
      {
        src: 'https://www.msgmorph.com/widget.js',
        'data-widget-id': 'wgt_179ae4cef2c1578e0c5ae1090c03f6cd',
        'data-base-url': 'https://api.msgmorph.com',
      },
    ],
  }),
