...
>(
    (
        ...
        // We use useControlledState so that the prop takes priority if it's defined.
        const [openInternal, _setOpenInternal] = React.useState(defaultOpen)
        ...
        // We add a state so that we can use it to determine if we should animate the sidebar.
...
>(({ className, showIcon = false, ...props }, ref) => {
    // Width of the skeleton based on a random number between 50 and 90.
    ...
    return (
        ...
        >
            ...
            <div
                className="h-4 flex-1 max-w-[--skeleton-width] rounded-md bg-sidebar-foreground/10"
