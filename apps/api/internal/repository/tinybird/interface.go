...
//go:generate mockgen -destination=mocks/mock_tinybird.go -package=mocks github.com/emailapi/api/internal/repository/tinybird EmailRepositoryInterface,ActivityRepositoryInterface

import (
	"context"
)

// EmailRepositoryInterface defines the interface for Tinybird email operations.
...
// ActivityRepositoryInterface defines the interface for Tinybird activity operations.
